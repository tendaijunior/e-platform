...
<div class="container-fluid">
    <form action="" id="schedule-form">
        ...
        <div class="form-group">
            <label for="course_id" class="control-label">Train</label>
            <select name="course_id" id="course_id" class="form-control form-control-border select2" >
                <?php 
                $trains = $conn->query("SELECT * FROM train_list where delete_flag = 0 ".(isset($course_id) && !empty($course_id) ? " or id = '{$course_id}' " : "")." order by name asc");
